...
// ctor
///////////////////////////////////////////////////////////////////////////////
SpherePrimitive::SpherePrimitive(float radius, int sectors, int stacks, bool smooth, int up) : interleavedStride(32), Primitive(PrimitiveType::Sphere)
{
...
// setters
///////////////////////////////////////////////////////////////////////////////
void SpherePrimitive::set(float radius, int sectors, int stacks, bool smooth, int up)
{
    if (radius > 0)
        this->radius = radius;
...
void SpherePrimitive::regenerateGeometry()
{
    // Clean up previous VAO, VBO, EBO
    if (VAO != 0)
    ...
    // Generate and bind the VBO for interleaved vertices
    glGenBuffers(1, &VBO);
    glBindBuffer(GL_ARRAY_BUFFER, VBO);
    glBufferData(GL_ARRAY_BUFFER, interleavedVertices.size() * sizeof(float), interleavedVertices.data(), GL_STATIC_DRAW);

    // Set vertex attribute pointers
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, interleavedStride, (void *)0); // Vertex position
    glEnableVertexAttribArray(0);
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, interleavedStride, (void *)(3 * sizeof(float))); // Normal
    glEnableVertexAttribArray(1);
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, interleavedStride, (void *)(6 * sizeof(float))); // Texture coordinates
...
void SpherePrimitive::setUpAxis(int up)
{
...
///////////////////////////////////////////////////////////////////////////////
void SpherePrimitive::reverseNormals()
{
    std::size_t i, j;
...
///////////////////////////////////////////////////////////////////////////////
void SpherePrimitive::Draw(Shader &shader)
{
    if (!enabled)
        return;
...
///////////////////////////////////////////////////////////////////////////////
// void SpherePrimitive::drawLines(const float lineColor[4]) const
// {
//     // set line colour
...
///////////////////////////////////////////////////////////////////////////////
void SpherePrimitive::changeUpAxis(int from, int to)
{
